    ...
    <Card className={`relative transition-all ${isSelected ? 'border-primary ring-2 ring-primary' : ''}`}>
      ...
      <CardContent className="p-4">
        <div className="flex items-start justify-between">
          ...
          <div>
            <CardTitle className="text-sm items-center justify-center mt-1 dark:text-red-500 text-red-600">Tempo mínimo: {service.minService ? (service.minService + " minutos") : "Indefinido"}</CardTitle>
          </div>
        </div>
        <div className="mt-2">
