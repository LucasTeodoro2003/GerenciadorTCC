...
export const columns: ColumnDef<Products>[] = [
  ...
  return (
    <div className="flex space-x-2">
      <Button variant="outline" className="h-8 px-3" onClick={() => router.push(`/dashboard/enterprise?table=products&description=${products.description}&amount=${products.amount}&minAmount=${products.minAmout}&price=${products.price}`)}>
